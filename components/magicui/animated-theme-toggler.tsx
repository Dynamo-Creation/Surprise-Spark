...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    // innerWidth/innerHeight: percentages resolve against snapshot reference box
    ...
    // Pin the collapsed clip-path via CSS to avoid unclipped flash before animation starts
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "relative inline-flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500",
        className
      )}
